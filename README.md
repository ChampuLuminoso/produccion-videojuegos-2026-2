...
El desarrollo sigue una arquitectura estructurada de carpetas dentro del directorio `src/`:
* `src/scenes/`: Contenedor de pantallas lógicas y flujos visuales del sistema.
* `src/scripts/`: Lógica GDScript pura para el control y la interacción de la aplicación.
* `src/assets/`: Recursos multimedia (audio, UI, texturas) debidamente clasificados.
